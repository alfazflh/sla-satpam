            ...
            <form id="mainForm" action="submit_form.php" method="POST" enctype="multipart/form-data" class="p-6">
                ...
                <div class="form-section hidden" data-section="3">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(4)" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="4">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handlePengamananNext()" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="5">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(7)" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="7">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handleFungsiKhususNext()" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="8">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(10)" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="10">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handleMemantauNext()" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="11">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(12)" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="12">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handlePelayananNext()" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="13">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(14)" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="14">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handleForceMajeureNext()" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="15">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(16)" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="16">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handlePenertibanNext()" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="17">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(18)" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="18">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handleSimulasiNext()" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="19">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(20)" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="20">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handlePenyegaranNext()" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="21">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(22)" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="22">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handleTeleponNext()" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="23">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(24)" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="24">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handleRutinNext()" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="25">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(26)" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="26">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handlePengecekanNext()" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="27">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(28)" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="28">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handleCCTVNext()" class="flex-1 bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
