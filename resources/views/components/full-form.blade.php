            ...
            <form id="mainForm" action="{{ route('laporan.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                ...
                <div class="form-section hidden" data-section="2">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handleSeragamNext()" class="flex-1 bg-[#1f7389] text-white py-3 px-4 rounded-lg hover:bg-[#196275] font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="3">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(4)" class="flex-1 bg-[#1f7389] text-white py-3 px-4 rounded-lg hover:bg-[#196275] font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="4">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handlePengamananNext()" class="flex-1 bg-[#1f7389] text-white py-3 px-4 rounded-lg hover:bg-[#196275] font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="5">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(7)" class="flex-1 bg-[#1f7389] text-white py-3 px-4 rounded-lg hover:bg-[#196275] font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="7">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handleFungsiKhususNext()" class="flex-1 bg-[#1f7389] text-white py-3 px-4 rounded-lg hover:bg-[#196275] font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="8">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(10)" class="flex-1 bg-[#1f7389] text-white py-3 px-4 rounded-lg hover:bg-[#196275] font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="10">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handleMemantauNext()" class="flex-1 bg-[#1f7389] text-white py-3 px-4 rounded-lg hover:bg-[#196275] font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="11">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(12)" class="flex-1 bg-[#1f7389] text-white py-3 px-4 rounded-lg hover:bg-[#196275] font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="12">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handlePelayananNext()" class="flex-1 bg-[#1f7389] text-white py-3 px-4 rounded-lg hover:bg-[#196275] font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="13">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(14)" class="flex-1 bg-[#1f7389] text-white py-3 px-4 rounded-lg hover:bg-[#196275] font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="14">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handleForceMajeureNext()" class="flex-1 bg-[#1f7389] text-white py-3 px-4 rounded-lg hover:bg-[#196275] font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="15">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(16)" class="flex-1 bg-[#1f7389] text-white py-3 px-4 rounded-lg hover:bg-[#196275] font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="16">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handlePenertibanNext()" class="flex-1 bg-[#1f7389] text-white py-3 px-4 rounded-lg hover:bg-[#196275] font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="17">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(18)" class="flex-1 bg-[#1f7389] text-white py-3 px-4 rounded-lg hover:bg-[#196275] font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="18">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handleSimulasiNext()" class="flex-1 bg-[#1f7389] text-white py-3 px-4 rounded-lg hover:bg-[#196275] font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="19">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="nextSection(20)" class="flex-1 bg-[#1f7389] text-white py-3 px-4 rounded-lg hover:bg-[#196275] font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="20">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" onclick="handlePenyegaranNext()" class="flex-1 bg-[#1f7389] text-white py-3 px-4 rounded-lg hover:bg-[#196275] font-medium">
                            Berikutnya
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section hidden" data-section="25">
                    ...
                    <div class="mb-6">
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                            Jumlah Titik Patroli (Angka) <span class="text-red-500">*</span>
                        </label>
...
// Object untuk menyimpan file per field
const fileStorage = {};
    ...
    if (!realInput.dataset.hasListener) {
        realInput.addEventListener('change', function(e) {
            ...
            if (newFiles.length > 0) {
                ...
                console.log(`✅ Total ${fileStorage[fieldName].files.length} file untuk ${fieldName}`);
            }
        });
...
// ✅ FIXED: Validasi dengan cek fileStorage
function validateCurrentSection() {
    const currentSectionElement = document.querySelector(`[data-section="${currentSection}"]`);
    const requiredFields = currentSectionElement.querySelectorAll('[required]');
    ...
    requiredFields.forEach(field => {
        if (field.type === 'radio') {
            ...
            // ✅ CEK DARI fileStorage, bukan field.files
            const fieldName = field.name;
            const hasFiles = fileStorage[fieldName] && fileStorage[fieldName].files.length > 0;
            
            if (!hasFiles && !firstInvalidField) {
                isValid = false;
                firstInvalidField = field;
                errorMessage = 'Silakan upload file yang diperlukan';
            }
...
// ✅ FIXED: Form submission dengan proper file handling
document.addEventListener('DOMContentLoaded', function() {
